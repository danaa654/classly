...
// the one place in the Programs module that needs to render the flash.
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-[var(--text-muted)]">
                            {{ programs.length }} {{ programs.length === 1 ? 'program' : 'programs' }} on record
                        </p>
                    </div>
                </div>
            ...
            <table class="w-full">
                ...
                <thead class="border-b border-[var(--card-border)] bg-[var(--page-bg)]">
                    <tr>
                        ...
                        <th class="text-left p-4 text-[10px] font-semibold uppercase tracking-wider text-[var(--text-muted)]">Program Code</th>
                        <th class="text-left p-4 text-[10px] font-semibold uppercase tracking-wider text-[var(--text-muted)]">Program Name</th>
                        <th class="text-center p-4 text-[10px] font-semibold uppercase tracking-wider text-[var(--text-muted)]">Years</th>
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="p-4 text-center">
                            <span class="inline-flex items-center rounded-full bg-[var(--page-bg)] border border-[var(--card-border)] px-2.5 py-0.5 text-xs font-medium text-[var(--text-secondary)]">
                                {{ program.years }} {{ program.years === 1 ? 'yr' : 'yrs' }}
                            </span>
                        </td>
                    ...
                    <tr v-if="programs.length === 0">
                        <td colspan="6" class="p-12 text-center">
                            ...
                            <p class="font-medium text-[var(--text-secondary)]">No programs yet</p>
                            <p class="mt-1 text-sm text-[var(--text-muted)]">Add your first program to start building curricula.</p>
                        </td>
                    </tr>
