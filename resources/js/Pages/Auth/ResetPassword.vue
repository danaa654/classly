                ...
                >
                    ...
                    <div class="relative px-7 py-9 sm:px-9">
                        ...
                        <p class="mb-6 text-center text-xs leading-relaxed text-slate-500 dark:text-[#8B93A7]">
                            Choose a strong password you haven't used before on
                            this account.
                        </p>
                        ...
                        <form @submit.prevent="submit" class="flex flex-col gap-4">
                            ...
                            <div>
                                <label for="password" class="mb-1.5 block text-xs font-medium text-[#16213E]/80 dark:text-[#F3EFE6]/80">New password</label>
                                <div class="relative">
                                    <input
                                        id="password"
                            ...
                            <div>
                                <label for="password_confirmation" class="mb-1.5 block text-xs font-medium text-[#16213E]/80 dark:text-[#F3EFE6]/80">Confirm password</label>
                                <div class="relative">
                                    <input
                                    ...
                                    <button
                                        ...
                                        class="absolute inset-y-0 right-0 flex w-10 items-center justify-center text-slate-400 transition-colors duration-200 hover:text-[#A8790E] focus:outline-none focus-visible:text-[#D4A62A] dark:text-[#8B93A7] dark:hover:text-[#E8C766]"
                                    >
                                        <EyeSlashIcon v-if="showPasswordConfirmation" class="h-4 w-4" />
                                        <EyeIcon v-else class="h-4 w-4" />
                                    </button>
                                </div>
                                <p v-if="form.errors.password_confirmation" class="mt-1.5 text-xs text-rose-600 dark:text-[#E8828C]">
